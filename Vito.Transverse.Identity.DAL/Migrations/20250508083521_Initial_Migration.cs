    ...
    public partial class Initial_Migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    SchemaName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuditEntityFk = table.Column<long>(type: "bigint", nullable: false),
                    AuditTypeFk = table.Column<long>(type: "bigint", nullable: false),
                    AuditEntityIndex = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    HostName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    ...
                    AuditInfoJson = table.Column<string>(type: "text", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditRecords_AuditEntities",
                        column: x => x.AuditEntityFk,
                        principalTable: "AuditEntities",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyEntityAudits_AuditEntities",
                        column: x => x.AuditEntityFk,
                        principalTable: "AuditEntities",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddtionalInformation = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditRecords_AuditEntityFk",
                table: "AuditRecords",
                column: "AuditEntityFk");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyEntityAudits_AuditEntityFk",
